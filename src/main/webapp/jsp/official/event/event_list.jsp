                                                ...
                                                <%--<div class='hidden-phone visible-desktop btn-group'>--%>
                                                    ...
                                                    <%--<div class="inline position-relative">--%>
                                                        ...
                                                        <%--<ul class="dropdown-menu dropdown-icon-only dropdown-light pull-right dropdown-caret dropdown-close">--%>
                                                            <%--<c:if test="${QX.edit == 1 }">--%>
                                                                <%--<li><a style="cursor:pointer;" title="编辑" onclick="edit('${var.EVENT_ID}');" class="tooltip-success" data-rel="tooltip" title="" data-placement="left"><span class="green"><i class="icon-edit"></i></span></a></li>--%>
                                                            <%--</c:if>--%>
                                                            <%--<c:if test="${QX.del == 1 }">--%>
                                                                <%--<li><a style="cursor:pointer;" title="删除" onclick="del('${var.EVENT_ID}');" class="tooltip-error" data-rel="tooltip" title="" data-placement="left"><span class="red"><i class="icon-trash"></i></span> </a></li>--%>
                                                            <%--</c:if>--%>
                                                        <%--</ul>--%>
                                                    <%--</div>--%>
                                                <%--</div>--%>
