						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
                                        ...
                                        <td><div style="width:100px;column-width: auto;max-height:100px;overflow:hidden;over-flow:hidden" title=${var.IMG_LINK}><a href="${var.IMG_LINK}" target="_blank"><img src="${pageContext.request.contextPath}/img.jsp?url=${var.IMG_LINK}"/></a></div></td>
                                        <td><div style="width:100px;column-width: auto;max-height:100px;overflow:hidden;over-flow:hidden" title=${var.HEAD_IMAGE}><a href="${pageContext.request.contextPath}/img.jsp?url=${var.HEAD_IMAGE}" target="_blank"><img src="${pageContext.request.contextPath}/img.jsp?url=${var.HEAD_IMAGE}"/></a></div></td>
