    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                ...
                <!-- 检索  -->
                <form action="article/offline.do" method="post" name="Form" id="Form">
                    <table>
                        <tr>
                            <td>
                                ...
                                <c:if test="${QX.cha == 1 }">
                                    <c:forEach items="${varList}" var="var" varStatus="vs">
                                        <tr>
                                            ...
                                            <td><div style="width:100px;max-height:100px;overflow:hidden;column-width: auto;over-flow:hidden" title=${var.IMG_LINK}><a href="${var.IMG_LINK}" target="_blank"><img src="${pageContext.request.contextPath}/img.jsp?url=${var.IMG_LINK}"/></a></div></td>
                                            <td><div style="width:100px;max-height:100px;overflow:hidden;column-width: auto;" title=${var.HEAD_IMAGE}><a href="${var.HEAD_IMAGE}" target="_blank"><img src="${pageContext.request.contextPath}/img.jsp?url=${var.HEAD_IMAGE}"/></a></div></td>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td style="vertical-align:top;">
                                    <c:if test="${QX.add == 1 }">
                                        <a class="btn btn-small btn-success" onclick="manual();">手动导入</a>

                                        <a class="btn btn-small btn-success" onclick="add();">新增文章</a>

                                        <a class="btn btn-small btn-primary" onclick="makeAll('确定要上线至热门动态吗?');">上线热门动态</a>

                                        <a class="btn btn-small btn-primary" onclick="makeAll('确定要上线至行业推荐吗?');">上线行业推荐</a>
                                    </c:if>
                                    <c:if test="${QX.del == 1 }">
...
<script type="text/javascript">
    ...
    function manual(){
        ...
        diag.Drag=true;
        diag.Title ="手动导入";
        diag.URL = '<%=basePath%>/article/goManualAdd.do';
        diag.Width = 450;
        diag.Height = 355;
        ...
        bootbox.confirm(msg, function(result) {
            if(result) {
                ...
                if(str==''){
                    ...
                    }else if(msg == '确定要上线至热门动态吗?'){
                        $.ajax({
                            type: "POST",
                            url: '<%=basePath%>/article/onlineAll.do?category=1',
                            data: {DATA_IDS:str},
                            dataType:'json',
                            //beforeSend: validateData,
                            cache: false,
                    ...
                    }else if(msg == '确定要上线至行业推荐吗?'){
                        $.ajax({
                            type: "POST",
                            url: '<%=basePath%>/article/onlineAll.do?category=2',
                            data: {DATA_IDS:str},
                            dataType:'json',
                            //beforeSend: validateData,
                            cache: false,
